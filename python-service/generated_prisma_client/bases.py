...
class BaseCallLog(_PrismaModel):
    __prisma_model__: ClassVar[Literal['CallLog']] = 'CallLog'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.CallLogActions[_PrismaModelT]':
        from .client import get_client

        return actions.CallLogActions[_PrismaModelT](client or get_client(), cls)
