...
SCHEMA_PATH = Path('/Users/shivansh/Code/Assignment/attack-capital-amd/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/shivansh/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    calllog: 'actions.CallLogActions[models.CallLog]'
    ...
    def __init__(
        ...
        *,
        ...
        self.calllog = actions.CallLogActions[models.CallLog](self, models.CallLog)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/shivansh/Code/Assignment/attack-capital-amd/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.calllog = CallLogBatchActions(self)
